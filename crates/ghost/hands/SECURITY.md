...
**ghost-hands** is an open-source component of [Ryu](https://ryuhq.com), maintained by
A Major Pte. Ltd.
...
ghost-hands exposes synthetic keyboard and mouse input control — capabilities with an inherently elevated security and privacy surface.
